...
const Island = ({ isRotating, setIsRotating, currentStage, setCurrentStage, currentFocusPoint, setBeeFacingLeft, setRotationDirection,...props }) => {
    ...
    useFrame(() => {
        ...
        if (!isRotating) {
            ...
            if (Math.abs(rotationSpeed.current) < 0.011) {
            ...
            */
            ...
            switch (true) {
                case normalizedRotation >= 0 && normalizedRotation < 1:
                    setCurrentStage(1);
                    break;
                case normalizedRotation >= 3 && normalizedRotation < 6.283: // 2π ~6.283
                    setCurrentStage(2);
                    break;
                case normalizedRotation >= 1 && normalizedRotation < 3:
                    setCurrentStage(3);
                    break;
                default:
    ...
    useEffect(() => {
        if (islandRef.current) {
            islandRef.current.rotation.y = 0;   // adjust this angle if needed!
        }
        setCurrentStage(1);
    }, [])
